...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    window.location.href = 'http://98.92.251.154:8000/api/v1/auth/cognito/login?provider=Google&role=technician'
  }

  const handleFacebookLogin = () => {
    window.location.href = 'http://98.92.251.154:8000/api/v1/auth/cognito/login?provider=Facebook&role=technician'
  }
