  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-6 bg-white border border-slate-100 shadow-md space-y-4 text-slate-800 leading-relaxed">
        <p className="text-sm">Welcome to FIXORA. By downloading, accessing, or using this application, you agree to these Terms &amp; Conditions. If you do not agree, please do not use the application.</p>
        ...
        <p className="text-sm">All content, design, logo, features, and code belong to FIXORA. You may not copy, modify, or distribute any part of the app without permission.</p>
        ...
        <p className="text-sm">FIXORA is not responsible for direct or indirect damages from using the app, and we do not guarantee complete accuracy of data or results.</p>
