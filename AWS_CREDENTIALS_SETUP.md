# 🔐 FIXORA — AWS Credentials Setup Guide

This guide describes the exact steps required to obtain and configure your AWS credentials for the FIXORA platform.
...
1.  Click on the user you just created (`fixora-api-user`).
...
3.  **Bucket name**: `fixora-uploads-[your-name]` (must be unique).
...
3.  Select **Standard**.
4.  **Name**: `fixora-alerts`
5.  Click **Create topic**.
6.  Copy the **ARN** (e.g., `arn:aws:sns:ap-south-1:1234567890:fixora-alerts`).
...
# AWS S3 (Storage)
AWS_S3_BUCKET_NAME=fixora-uploads-[your-name]
